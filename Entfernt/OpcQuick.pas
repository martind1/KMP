...
const
  ...
  Item0Name = 'S7:[DEMO]DB10,INT0,10';
  Item1Name = 'S7:[DEMO]DB10,w10';
...
begin
  ...
  Writeln('========================================================');
  Writeln('Simple OPC client program, by Mike Dillamore, 1998-2001.');
  Writeln('Tested for compatibility with Delphi 3, 4, 5 and 6.     ');
