unit Rhewa83zKmp;
(* Rhewa Fahrzeugwaage - Auswertegerät 83Z
29.03.11 md  erstellt (rag701)
--------------------------------------------------
*)
interface
...
procedure Rhewa83z.BuildDescription;
(*
Am Gerät: "Rückmeldung aktiviert"
Ausgabeschnittstelle: 0 (=Einstellung am Gerät)

Status (Brutto):
PC:    <GB1>
Waage wenn OK: <GB   1.557>
Waage wenn Fehler: <GBx>   x = !/%/#
      wenn Überlast: "- - -"
...
begin
  ...
  Description.Clear;
  Description.Add('S:<');               {Startzeichen senden}
  Description.Add('B:');                {reine Daten}
  Description.Add('S:>');               {Endezeichen}
...
constructor Rhewa83z.Create(AOwner: TComponent);
begin
...
procedure Rhewa83z.Loaded;
begin
  inherited Loaded;
  BuildDescription;
end;

destructor Rhewa83z.Destroy;
begin
  StrDispose(Antwort);
  Antwort := nil;
  DescrProt.Free;
...
procedure Rhewa83z.StrToWaStat(Tok: PAnsiChar; var Status: TFaWaStatus);
...
procedure Rhewa83z.DoAntwort(Sender: TObject; Tel_Id: Longint);
var
...
procedure Rhewa83z.DoSimul(ATel: TTel);
...
function Rhewa83z.ProtGewicht(Beizeichen: string): longint;
var
...
function Rhewa83z.HoleStatus: longint;
var
  Befehl : array[0..200] of AnsiChar;
  BefLen: integer;
begin
...
function Rhewa83z.DelSpNr(SpNr: integer): longint;
begin
  Result := -1;
end;

function Rhewa83z.Quittieren: longint;
begin
  Result := -1;
end;

function Rhewa83z.Zeilendruck(Zeile: string): longint;
var
  Befehl : array[0..200] of AnsiChar;
  BefLen: integer;
begin
...
function Rhewa83z.DruckeBlock(ABlock: TStrings): longint;
var
  I: integer;
begin
  Result := -1;
...
function Rhewa83z.GerAdr: AnsiChar;
begin
  Result := AnsiChar(chr(GerNr + ord('A') - 1));    {1 -> 'A'}
end;

procedure Rhewa83z.UserFnk(ATel: TTel; FnkName : string);
var
