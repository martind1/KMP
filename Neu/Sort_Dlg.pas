...
(* Dialog für Sortieren
   ...
   21.11.13 md  Idee mit CheckListbox (nicht fertig)
*)
...
uses WinTypes, WinProcs, Classes, Graphics, Forms, Controls, Buttons,
  StdCtrls,
  Qwf_Form, DPos_Kmp, Vcl.CheckLst;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if (AKeyFields = DlgSort.KeyList.Value(I)) or
           (AscKeyFields = DlgSort.KeyList.Value(I)) then
        try
