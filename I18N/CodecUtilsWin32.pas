...
{$ENDIF}
    class function CPEncodingName(const CP: integer): string; static;
...
class function TEncodingRepository.CPEncodingName(const CP: integer): string;
begin
  // returns the ANSI code-page identifier for the system,
  // or a default identifier if no code page is current.
  case CP of
    874  : Result := 'cp874';            // Thai
    932  : Result := 'cp932';            // Japan
