...
(* List of Values Dialog
   ...
   29.11.11 md  TranslateFrm
   31.01.14 md  LovMaxWidth nicht mehr typed constant
*)
interface
...
{$endif}
  ...
  Grids, DBGrids,
  Mugrikmp, NLnk_Kmp, Lnav_kmp, DPos_Kmp, UDS__Kmp, UQue_Kmp,      {JM 23.01.02}
  Qwf_Form;
...
begin
  ...
  try
    try
      Query1.DataBaseName := (LovNLDataSet(ANavLink) as IUDataset).GetDataBaseName;
