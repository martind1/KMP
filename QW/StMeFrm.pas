...
(* Meldungen definieren
   ...
   02.04.13 md  STME4 'LIMS4' neue Probenergebnisse
*)
interface
...
uses
  ...
  nstimer, Menus, UQue_Kmp, UDB__Kmp;
...
begin
  ...
  begin                 {Datenbankeinstellungen überschreiben INI-Einstellungen}
    ...
    begin
      ...
      GNavigator.NoTranslateList.Add(EdWAVSec.Hint);
    end;
    ...
    begin
      ...
      GNavigator.NoTranslateList.Add(EdWAV.Hint);
    end;
    ...
    begin
      ...
      GNavigator.NoTranslateList.Add(chbPopup.Hint);
    end;
    ...
    begin
      ...
      GNavigator.NoTranslateList.Add(edFltrSTME_NR.Hint);
    ...
    begin
      ...
      GNavigator.NoTranslateList.Add(edFltrWERK_NR.Hint);
    end;
    ...
    begin
      ...
      GNavigator.NoTranslateList.Add(edFltrBEIN_NR.Hint);
      cobFltrPrdg.Enabled := false;
    end;
    if Kurz = 'STME3' then
      BtnMain := FrmMain.BtnStMe3 else
    if Kurz = 'STME4' then
      BtnMain := FrmMain.BtnStMe4 else
...
begin
  ...
  begin
    ...
    GNavigator.NoTranslateList.Add(BtnMain.Hint);
  end;
  if First then
  begin
    First := false;
...
begin
  ...
  try
    NSTimer.Interval := StrToIntTol(EdWavSec.Text) * 1000;
    queSTME.Close;
    queSTME.SQL.Text := 'select  /*+ALL_ROWS */ count(*) from STOERMELDUNGEN ' + TI.Where;
    queSTME.Open;
