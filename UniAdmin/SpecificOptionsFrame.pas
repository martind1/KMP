...
type
  ...
  TFrSpecificOptions = class(TFrame)
    Panel1: TPanel;
    Label1: TLabel;
...
constructor TFrSpecificOptions.Create(Owner: TComponent);
begin
...
function TFrSpecificOptions.CheckOptionDefault(Option: TOption; var Value: _string): boolean;
var
...
procedure TFrSpecificOptions.LoadOptions(const ProviderName: string; OptionsType: TOptionsType;
...
procedure TFrSpecificOptions.SaveOptions;
var
  i, j: integer;
  Value, Name: _string;
  Option: TOption;
...
{$IFDEF USE_VALEDIT}
procedure TFrSpecificOptions.edOptionsGetPickList(Sender: TObject;
...
procedure TFrSpecificOptions.edOptionsValidate(Sender: TObject; ACol,
...
procedure TFrSpecificOptions.edOptionsDrawCell(Sender: TObject; ACol,
...
procedure TFrSpecificOptions.edOptionsExit(Sender: TObject);
begin
  SaveOptions;
end;

procedure TFrSpecificOptions.edProviderChange(Sender: TObject);
begin
  SaveOptions;
